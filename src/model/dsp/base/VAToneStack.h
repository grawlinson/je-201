    ...
    void updateFilterCoefficients (float low, float top)
    {
        if (Low != low || Top != top)
        {
            ...
            b2 = top * (C1 * C2 * R1 * R4 + C1 * C3 * R1 * R4) - midsquared * (C1 * C3 * R3squared + C2 * C3 * R3squared)
                 + mid * (C1 * C3 * R1 * R3 + C1 * C3 * R3squared + C2 * C3 * R3squared) + low * (C1 * C2 * R1 * R2 + C1 * C2 * R2 * R4 + C1 * C3 * R2 * R4) + low * mid * (C1 * C3 * R2 * R3 + C2 * C3 * R2 * R3) + (C1 * C2 * R1 * R3 + C1 * C2 * R3 * R4 + C1 * C3 * R3 * R4);
